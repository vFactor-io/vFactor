  ...
  embeds: [
    {
      ...
      description:
        options.target === "prerelease"
          ? "A new vFactor prerelease is available for nightly testers."
          : "A new vFactor latest release is available.",
...
).pipe(Command.withDescription("Post a vFactor release announcement to Discord."));

...
const PATH_CAPTURE_START = "__VFACTOR_PATH_START__";
const PATH_CAPTURE_END = "__VFACTOR_PATH_END__";
...
function envCaptureStart(name: string): string {
  return `__VFACTOR_ENV_${name}_START__`;
}

function envCaptureEnd(name: string): string {
  return `__VFACTOR_ENV_${name}_END__`;
}

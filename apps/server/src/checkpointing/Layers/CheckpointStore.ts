    ...
    yield* Effect.acquireUseRelease(
      ...
      Effect.fn("captureCheckpoint.withTempDirectory")(function* (tempDir) {
        ...
        const commitEnv: NodeJS.ProcessEnv = {
          ...
          GIT_AUTHOR_NAME: "vFactor",
          GIT_AUTHOR_EMAIL: "vfactor@users.noreply.github.com",
          GIT_COMMITTER_NAME: "vFactor",
          GIT_COMMITTER_EMAIL: "vfactor@users.noreply.github.com",
        };

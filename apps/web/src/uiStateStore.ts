...
export const PERSISTED_STATE_KEY = "vfactor:ui-state:v1";
const LEGACY_PERSISTED_STATE_KEYS = [
  "vfactor:renderer-state:v8",
  "vfactor:renderer-state:v7",
  "vfactor:renderer-state:v6",
  "vfactor:renderer-state:v5",
  "vfactor:renderer-state:v4",
  "vfactor:renderer-state:v3",

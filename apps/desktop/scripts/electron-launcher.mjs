// This file mostly exists because we want dev mode to say "vFactor (Dev)" instead of "electron"
...
const APP_BUNDLE_ID = isDevelopment ? "com.t3tools.vfactor.dev" : "com.t3tools.vfactor";
...
const developmentMacIconIcnsPath = join(repoRoot, "assets", "vfactor", "dev", "icon.icns");
...
function resolveDevelopmentIconIcns() {
  if (existsSync(developmentMacIconIcnsPath)) {
    return developmentMacIconIcnsPath;
  }
...
function buildMacLauncher(electronBinaryPath) {
  ...
  const iconPath = isDevelopment ? resolveDevelopmentIconIcns() : defaultIconPath;
